/* =========================================
   ...
   (routes/auth.routes.js) we issue our OWN signed, httpOnly cookie. Every
...
module.exports = {
  COOKIE_NAME, signSession, verifySession, cookieOptions,
  ADMIN_COOKIE_NAME, checkAdminPassword, signAdminSession, verifyAdminSession, adminCookieOptions,
};
