...
<nav class="navbar" id="navbar">
  <a href="index.html" class="nav-logo">
    <img src="images/brineandshell.png" width="44" height="44" alt="Brine & Shell logo" onerror="this.style.display='none'" />
  ...
  <div class="footer-top">
    <div class="footer-brand">
      <div class="footer-logo">
        <img src="images/brineandshell.png" width="40" height="40" alt="Brine & Shell" onerror="this.style.display='none'" />
    ...
    <div class="footer-links">
      <h4>Contact</h4>
      <a href="mailto:hello@brineandshell.com">hello@brineandshell.com</a>
